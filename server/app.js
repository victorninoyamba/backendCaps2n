...
const mongoUrl =
  "mongodb+srv://jergcauso:MariaAndrea100711@cluster0.xtgcafp.mongodb.net/adminpanel?retryWrites=true&w=majority";
...
app.post("/sendinquiry", async (req, res) => {
  const { fname, mname, lname, contact, email, address, occupation, message } =
    req.body;
  try {
...
app.get("/getAllInquiries", async (req, res) => {
  try {
